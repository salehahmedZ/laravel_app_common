...
final class AppleDevices
{
    public static array $appleDevices = [
        ...
        'iPad6,12' => 'iPad (5th generation) Wi-Fi',
        ...
        'MacBookPro11,3' => 'MacBook Pro (Retina, 15-inch, Mid 2014, Dual Graphics)',
    ...
    public static array $androidDevices = [
        ...
        'Infinix X695' => 'Infinix Note 10 Pro',
        'SH-01L' => 'DoCoMo AQUOS sense2',
        //
        ...
        'SM-N975F' => 'Samsung Galaxy Note 10 Plus',
        'SM-A125F' => 'Samsung Galaxy A12',
    ];

    public static function getDeviceName(?string $model): ?string
    {
        if ($model == null) {
            return null;
        }

        $appleDevices = array_change_key_case(self::$appleDevices, CASE_LOWER);
        $androidDevices = array_change_key_case(self::$androidDevices, CASE_LOWER);

        return $appleDevices[trim(strtolower($model))] ?? $androidDevices[trim(strtolower($model))] ?? $model;
    }
}
